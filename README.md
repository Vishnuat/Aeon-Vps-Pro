...
```
git clone https://github.com/lordgaruda/aeon-vps mirrorbot/ && cd mirrorbot
```
...
mediainfo - [media/url] Generate Mediainfo 
speedtest - Check Speedtest of your Bot
images - Get grid of all Images in Bot
addimg - [photo/url] Add image to Bot Images 
list - Search files in Drive
search - Search for torrents with API
stopall - Cancel all tasks
log - Get the Bot Log
shell - Run commands in Shell
eval - Evaluate Python Snippets 
exec - Execute Repo Functions 
